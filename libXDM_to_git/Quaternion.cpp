...
namespace GeneralLib
{
  ...
  //----------------------------------------------------------------------------------------------
  // Public : CreateFromRodrigues
  //
  //  
  //----------------------------------------------------------------------------------------------
  void SQuaternion::CreateFromRodrigues( const SVector3 &RFVec )
  {
    m_fW = cos( atan( sqrt( Dot(RFVec, RFVec) ) ) );
    m_fX = RFVec.m_fX * m_fW;
    m_fY = RFVec.m_fY * m_fW;
    m_fZ = RFVec.m_fZ * m_fW;
  }
  ...
  //----------------------------------------------------------------------------------------------
  // Public:  GetRodriguesVector
  //----------------------------------------------------------------------------------------------
  SVector3 SQuaternion::GetRodriguesVector() const
  {
    SVector3 RFVec( m_fX, m_fY, m_fZ );
    RFVec /= m_fW;
    return RFVec;
  }
