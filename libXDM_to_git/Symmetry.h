...
namespace LatticeSymmetry
{
  ...
  //  Identity Symmetry
  //--------------------------------------------------------------------------------
  class CIdentitySymmetry : public CSymmetry
  {
    
  public:
    static CIdentitySymmetry & Get();

  private:
    CIdentitySymmetry();
    CIdentitySymmetry(const CIdentitySymmetry &c);  // prevent copy construction
    const CIdentitySymmetry & operator= (const CIdentitySymmetry &c);
  };
