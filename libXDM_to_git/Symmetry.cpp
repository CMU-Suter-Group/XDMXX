...
namespace LatticeSymmetry
{
  ...
  //
  //-------------------------------------------------------------------------------------------
  CIdentitySymmetry & CIdentitySymmetry::Get()
  {
    static CIdentitySymmetry oIdentitySymmetry;
    return oIdentitySymmetry;
  }

   //-------------------------------------------------------------------------------------------
  //
  //  Public:  CIdentitySymmetry
  //
  //-------------------------------------------------------------------------------------------
  CIdentitySymmetry::CIdentitySymmetry()
  {
    SMatrix3x3 oSymMatrix;
    oSymMatrix.SetIdentity();
    oOperatorList.push_back(oSymMatrix);
    
    DEBUG_ASSERT(oOperatorList.size() == 1, "ERROR:  Missing Identity Symmetry Operator\n");
  ...
  namespace Utilities
  {
    ...
    CSymmetry* GetSymmetryObj( ESymmetryT eSym )
    {
      switch( eSym )
      {
        ...
        case LatticeSymmetry::eNone:
          return & ( LatticeSymmetry::CIdentitySymmetry::Get() );
        default:
